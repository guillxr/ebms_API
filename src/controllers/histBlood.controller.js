  ...
  readtype: async (req, res) => {
    ...
    try {
      ...
      if (!answer) {
        return res
          .status(404)
          .json({ error: `Nenhum dado encontrado para o tipo: ${type}` });
      }
    ...
    try {
      ...
      if (!answer) {
        return res
          .status(404)
          .json({
            error: `Nenhum dado encontrado para o tipo sanguíneo: ${search}`,
          });
      }
  ...
  delete: async (req, res) => {
    ...
    try {
      ...
      if (!answer) {
        return res
          .status(404)
          .json({ error: 'Nenhum dado encontrado para deletar.' });
      }
